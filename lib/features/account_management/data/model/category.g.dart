...
const CategorySchema = CollectionSchema(
  name: r'Category',
  schema:
      r'{"name":"Category","idName":"id","properties":[{"name":"createdAt","type":"Long"},{"name":"name","type":"String"},{"name":"updatedAt","type":"Long"}],"indexes":[],"links":[{"name":"productss","target":"Product"}]}',
  idName: r'id',
  propertyIds: {r'createdAt': 0, r'name': 1, r'updatedAt': 2},
  listProperties: {},
  indexIds: {},
  indexValueTypes: {},
  linkIds: {r'productss': 0},
  backlinkLinkNames: {},
...
void _categoryAttachLinks(
  ...
  object.productss.attach(col, col.isar.products, r'productss', id);
}
...
extension CategoryQueryLinks
    on QueryBuilder<Category, Category, QFilterCondition> {
  QueryBuilder<Category, Category, QAfterFilterCondition> productss(
